...
def save_plot(examples, epoch, n=10):
    ...
    # save plot to file
    filename = "output_files/adam/generated_plot_e%03d.png" % (epoch + 1)
...
def plot_history(d_hist, g_hist):
    ...
    # save plot to file
    pyplot.savefig('output_files/adam/adam.png')
    pyplot.close()
...
losses = open("output_files/adam/adam_loss.txt", "w+")
